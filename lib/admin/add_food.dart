...
class _AddFoodState extends State<AddFood> {
  ...
  uploadItem() async {
    if (selectedImage != null &&
      ...
      String foodItemId = randomAlphaNumeric(10);
      ...
      await DatabaseMethods().addFoodItem(addItem, userId!, foodItemId).then((value) {
  ...
  ontheload() async {
    userId = (jsonDecode((await SharedPreferenceHelper().getUserDetails())!))["Id"];
    setState(() {});
  }
